...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_hautpflegemittel_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='hautpflegemittel-view'
        )
        self.assertTrue(view.__name__ == 'hautpflegemittel-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in hautpflegemittel-view'
        # )

    def test_hautpflegemittel_view_not_matching_interface(self):

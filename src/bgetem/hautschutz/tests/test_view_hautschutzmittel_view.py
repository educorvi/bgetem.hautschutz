...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_hautschutzmittel_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='hautschutzmittel-view'
        )
        self.assertTrue(view.__name__ == 'hautschutzmittel-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in hautschutzmittel-view'
        # )

    def test_hautschutzmittel_view_not_matching_interface(self):

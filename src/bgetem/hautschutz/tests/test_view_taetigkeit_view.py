...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_taetigkeit_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='taetigkeit-view'
        )
        self.assertTrue(view.__name__ == 'taetigkeit-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in taetigkeit-view'
        # )

    def test_taetigkeit_view_not_matching_interface(self):

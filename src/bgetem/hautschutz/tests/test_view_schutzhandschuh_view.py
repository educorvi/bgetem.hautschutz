...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_schutzhandschuh_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='schutzhandschuh-view'
        )
        self.assertTrue(view.__name__ == 'schutzhandschuh-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in schutzhandschuh-view'
        # )

    def test_schutzhandschuh_view_not_matching_interface(self):

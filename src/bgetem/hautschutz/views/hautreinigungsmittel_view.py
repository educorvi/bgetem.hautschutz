...
class HautreinigungsmittelView(BrowserView):
    # If you want to define a template here, please remove the template from
    # the configure.zcml registration of this view.
    # template = ViewPageTemplateFile('hautreinigungsmittel_view.pt')
    ...
    def reibemittel(self):
        reibemittel = sefl.context.reibemittel
        return reibemittel

    def loesemittel(self):
        loesemittel = self.context.loesemittel
        return loesemittel
